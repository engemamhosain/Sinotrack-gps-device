...
var gps_data="*HQ,6170948096,V1,112605,A,2346.8111,N,09023.7068,E,001.39,000,130717,FFF7BBFF,470,03,00830,61182#";
var net = require('net');

var client = new net.Socket();
client.connect(6969, '103.199.168.131', function() {
